// src/app/novatarefas_aprontamento/page.tsx
'use client';

import { useState, useEffect } from 'react'; // Importar useEffect aqui
...
export default function SelecionarTarefaPage() {
  ...
  const { tarefas, isLoading, isError, refetch } = useNovaTarefasWS();

  // Atualiza a lista sempre que a aba fica visível
  useEffect(() => {
  ...
  const handleIncluirNovaTarefa = () => {
    ...
    router.push(`/apontamento_tarefa?tarefaId=${tarefaSelecionada.id}`);
  };
